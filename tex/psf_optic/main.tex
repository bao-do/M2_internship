...
\begin{align}
    ...
    &= \frac{e^{jk r_{01}}}{r_{01}^2}  \left(jk - \frac{1}{r_{01}}\right) \mathbf{r_{01}} \cdot \vect{n_\varepsilon} 
\end{align}
For a point $P_1$ on the small spherical surface $S_\varepsilon$, we have  $\mathbf{r_{01}} \cdot \vect{n_\varepsilon} = 1$ and $r_{01} = \varepsilon$, thus we can express $\frac{\partial G}{\partial n}$ as:
\begin{equation}
...
\begin{equation}
\frac{\partial G}{\partial n}(P_1)  = \frac{e^{-jk r_{01}}}{r_{01}^2}  \left(jk - \frac{1}{r_{01}}\right) \mathbf{r_{01}} \cdot \vect{n} 
\end{equation}
...
\begin{align}
\frac{\partial G}{\partial n} (P_1) &\approx \frac{e^{-jk r_{01}}}{r_{01}^2}  jk \mathbf{r_{01}} \cdot \vect{n} \\
&= jk \, \frac{e^{-jk r_{01}}}{r_{01}} \, \cos(\mathbf{r_{01}}, \vect{n})
\end{align}
...
\begin{equation}
\frac{\partial U}{\partial n} (P_1) \approx jk \, \frac{e^{jkr_{21}}}{r_{21}} \, \cos(\mathbf{r_{21}}, \vect{n})
\end{equation}
Then, \cref{eq:integral_over_aperture} is:
\begin{align}\label{eq:fresnel_kirchhoff_diffraction_formula}
    U(P_0) &= \frac{1}{4\pi} \int_\Sigma \frac{A j k e^{jk\Bigl(r_{21}+r_{01}\Bigl)}}{r_{21} \, r_{01}}\, \left( \cos(\mathbf{r_{21}}, \vect{n}) - \cos(\mathbf{r_{01}}, \vect{n})\right) \, dS \\
    &= \frac{A}{2j\lambda}\int_\Sigma \frac{e^{jk\Bigl(r_{21}+r_{01}\Bigl)}}{r_{21} \, r_{01}} \left( \cos(\mathbf{r_{01}}, \vect{n}) - \cos(\mathbf{r_{21}}, \vect{n})\right) \, dS
\end{align}
...
where 
\begin{equation}
U_s(P_1) = \frac{A}{2j\lambda} \, \frac{e^{jkr_{21}}}{r_{21}} \, \left( \cos(\mathbf{r_{01}}, \vect{n}) - \cos(\mathbf{r_{21}}, \vect{n})\right)
\end{equation}
...
\begin{equation}
U_I(P_0) = \frac{A}{j\lambda}\int_\Sigma \frac{e^{jk\Bigl(r_{21}+r_{01}\Bigl)}}{r_{21} \, r_{01}}  \, \cos(\mathbf{r_{01}}, \vect{n})  \, dS
\end{equation}
\begin{equation}
U_{II}(P_0) = \frac{A}{j\lambda}\int_\Sigma \frac{e^{jk\Bigl(r_{21}+r_{01}\Bigl)}}{r_{21} \, r_{01}}  \, \cos(\mathbf{r_{21}}, \vect{n})  \, dS
\end{equation}
...
\begin{equation}
\psi = \begin{cases}
\frac{1}{2} \left(\cos(\mathbf{r_{01}}, \vect{n}) - \cos(\mathbf{r_{21}}, \vect{n})\right) & \text{Fresnel-Kirchhoff theory} \\
\cos(\mathbf{r_{01}}, \vect{n}) & \text{Rayleigh-Sommerfeld theory I} \\
\cos(\mathbf{r_{21}}, \vect{n}) & \text{Rayleigh-Sommerfeld theory II}
\end{cases}
\end{equation}
...
\end{cases}
\end{equation}
where $\theta$ is the angle formed by $\vect{n}$ and $\mathbf{r_{01}}$.
